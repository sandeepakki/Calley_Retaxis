...
public class BuyerOrdering extends BaseClass{
	@BeforeMethod
	...
	driver.findElement(By.xpath("//body/div[@id='page']/form[@id='form1']/div[@id='divdefault']/div[@id='header-wrap']"+
 	...
 	for(int i=0;i<=0;i++) {
 		...
 		//P2 Seller Cancellation
 				...
 				driver.findElement(By.xpath("//a[@onclick='javascript:add_into_cart(\"SKU8\",\"Retaxis\",\"No\",\"SupplierCode|SKUCode|Color|Size|Variants|Model|Attribute1|Attribute2|Attribute3|Attribute4\",\"BMP-S1476378\",\"products\");']")).click();
 				driver.findElement(By.xpath("//button[@class='confirm']")).click();
 		//p3 Seller Cancellation
 				
 				driver.navigate().to("http://vedson.cstechns.com/products/ABC-Product7/Black/BMP-S1476378#.YE8jSJ0zbIU");
 				driver.findElement(By.xpath("//a[@onclick='javascript:add_into_cart(\"SKU7\",\"Retaxis\",\"No\",\"SupplierCode|SKUCode|Color|Size|Variants|Model|Attribute1|Attribute2|Attribute3|Attribute4\",\"BMP-S1476378\",\"products\");']")).click();
 				driver.findElement(By.xpath("//button[@class='confirm']")).click();
 		...
 		//p5 Others
 				driver.navigate().to("http://vedson.cstechns.com/products/FitBit2/Pink/BMP-S1855506#.YFR1Lq8zbIU");
 				driver.findElement(By.xpath("//input[@id='QtyAdd']")).click();
 		...
 		//p7
 				driver.navigate().to("http://vedson.cstechns.com/products/Beats/Green/BMP-S1855506#.YF7ODK8zbIU");
 				driver.findElement(By.xpath("//input[@id='QtyAdd']")).click();
 				Thread.sleep(1000);
 				driver.findElement(By.xpath("//input[@id='QtyAdd']")).click();
 				driver.findElement(By.xpath("//a[@onclick='javascript:add_into_cart(\"SK239283\",\"Retaxis\",\"No\",\"SupplierCode|SKUCode|Color|Size|Variants|Model|Attribute1|Attribute2|Attribute3|Attribute4\",\"BMP-S1855506\",\"products\");']")).click();
 				driver.findElement(By.xpath("//button[@class='confirm']")).click();
