...
public class ReturnOrder extends BaseClass {
	...
	public void testCase1() throws InterruptedException {
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
//1		same set - Replace
	driver.navigate().to("https://www.sohostyle.in/orderdetailsreturns/159-S1325863");
	Thread.sleep(1000);
	 driver.navigate().to("https://www.sohostyle.in/ReturnOrderdeatilView/159-S1325863-skucode125");
...
//2 Same Product - Refund
	...
	//3 Different Product - Refund
		driver.navigate().to("https://www.sohostyle.in/orderdetailsreturns/159-S1325863");
		Thread.sleep(1000);
		driver.navigate().to("https://www.sohostyle.in/ReturnOrderdeatilView/159-S1325863-MP120");
